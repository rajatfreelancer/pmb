    ...
    <div class="row">
        <div class="col-md-9">
            <div class="col-md-12 row">
                ...
                <div class="col-sm-3">asds</div>
                <div class="col-sm-3">Account No</div>
                <div class="col-sm-3">54544654564646</div>
            </div>
            <div class="col-md-12 row">
                <div class="col-md-3">Account Holder Name</div>
                <div class="col-sm-3">Rakhi</div>
                <div class="col-sm-3">s/d/h/f</div>
                <div class="col-sm-3">Pavan Kumar</div>
            </div>
            <div class="col-md-12 row">
                <div class="col-md-3">Address</div>
                <div class="col-sm-9">Rampura punjab kurali RV Tech Chandigarh</div>
            </div>
            <br>
            <div class="col-md-12 row">
                <div class="col-md-3">Contact No. </div>
                <div class="col-sm-3">9632587415</div>
                <div class="col-sm-3">BA ID</div>
                <div class="col-sm-3">BA002563</div>
            </div>
            <div class="col-md-12 row">
